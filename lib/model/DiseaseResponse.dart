...
DiseaseResponse problemResponseFromJson(String str) => DiseaseResponse.fromJson(json.decode(str));
String problemResponseToJson(DiseaseResponse data) => json.encode(data.toJson());
...
class DiseaseResponse {
  ...
  factory DiseaseResponse.fromJson(Map<String, dynamic> json) => DiseaseResponse(
